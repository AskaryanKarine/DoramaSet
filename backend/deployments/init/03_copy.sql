...
copy dorama_set.picture from '/data/picture.csv' delimiter ',' null as '' csv;
select setval('dorama_set.picture_id_seq', (select max(id) from dorama_set.picture));

copy dorama_set.staff from '/data/staff.csv' delimiter ',';
...
copy dorama_set."user" from '/data/admin.scv' delimiter ',';
