...
//go:generate minimock -i DoramaSet/internal/interfaces/repository.IListRepo -o ..\..\repository\mocks\i_list_repo_mock.go -n IListRepoMock
...
type IListRepoMock struct {
	...
	funcCreateList          func(list model.List) (i1 int, err error)
...
func (mmCreateList *mIListRepoMockCreateList) Set(f func(list model.List) (i1 int, err error)) *IListRepoMock {
	if mmCreateList.defaultExpectation != nil {
...
func (mmCreateList *IListRepoMock) CreateList(list model.List) (i1 int, err error) {
