...
//go:generate minimock -i DoramaSet/internal/interfaces/controller.IPointsController -o ./i_points_controller_mock_test.go -n IPointsControllerMock
...
// IPointsControllerMock implements IPointsController
type IPointsControllerMock struct {
	t minimock.Tester

	funcEarnPoint          func(ctx context.Context, user *model.User, point int) (err error)
	inspectFuncEarnPoint   func(ctx context.Context, user *model.User, point int)
	afterEarnPointCounter  uint64
	beforeEarnPointCounter uint64
	EarnPointMock          mIPointsControllerMockEarnPoint

	funcEarnPointForLogin          func(ctx context.Context, user *model.User) (err error)
	inspectFuncEarnPointForLogin   func(ctx context.Context, user *model.User)
	...
	funcPurgePoint          func(ctx context.Context, user *model.User, point int) (err error)
	inspectFuncPurgePoint   func(ctx context.Context, user *model.User, point int)
	afterPurgePointCounter  uint64
	beforePurgePointCounter uint64
	PurgePointMock          mIPointsControllerMockPurgePoint
}

// NewIPointsControllerMock returns a mock for IPointsController
...
func (mmEarnPoint *mIPointsControllerMockEarnPoint) Expect(ctx context.Context, user *model.User, point int) *mIPointsControllerMockEarnPoint {
	...
	mmEarnPoint.defaultExpectation.params = &IPointsControllerMockEarnPointParams{ctx, user, point}
...
func (mmEarnPoint *mIPointsControllerMockEarnPoint) Inspect(f func(ctx context.Context, user *model.User, point int)) *mIPointsControllerMockEarnPoint {
...
func (mmEarnPoint *mIPointsControllerMockEarnPoint) Set(f func(ctx context.Context, user *model.User, point int) (err error)) *IPointsControllerMock {
	if mmEarnPoint.defaultExpectation != nil {
...
// Then helper
func (mmEarnPoint *mIPointsControllerMockEarnPoint) When(ctx context.Context, user *model.User, point int) *IPointsControllerMockEarnPointExpectation {
	if mmEarnPoint.mock.funcEarnPoint != nil {
		mmEarnPoint.mock.t.Fatalf("IPointsControllerMock.EarnPoint mock is already set by Set")
	}
	...
	expectation := &IPointsControllerMockEarnPointExpectation{
		...
		params: &IPointsControllerMockEarnPointParams{ctx, user, point},
	}
...
// EarnPoint implements IPointsController
func (mmEarnPoint *IPointsControllerMock) EarnPoint(ctx context.Context, user *model.User, point int) (err error) {
	...
	if mmEarnPoint.inspectFuncEarnPoint != nil {
		mmEarnPoint.inspectFuncEarnPoint(ctx, user, point)
	}

	mm_params := &IPointsControllerMockEarnPointParams{ctx, user, point}
	...
	if mmEarnPoint.EarnPointMock.defaultExpectation != nil {
		...
		mm_got := IPointsControllerMockEarnPointParams{ctx, user, point}
	...
	if mmEarnPoint.funcEarnPoint != nil {
		return mmEarnPoint.funcEarnPoint(ctx, user, point)
	}
	mmEarnPoint.t.Fatalf("Unexpected call to IPointsControllerMock.EarnPoint. %v %v %v", ctx, user, point)
	return
}
...
func (mmEarnPointForLogin *mIPointsControllerMockEarnPointForLogin) Expect(ctx context.Context, user *model.User) *mIPointsControllerMockEarnPointForLogin {
	...
	mmEarnPointForLogin.defaultExpectation.params = &IPointsControllerMockEarnPointForLoginParams{ctx, user}
...
func (mmEarnPointForLogin *mIPointsControllerMockEarnPointForLogin) Inspect(f func(ctx context.Context, user *model.User)) *mIPointsControllerMockEarnPointForLogin {
...
func (mmEarnPointForLogin *mIPointsControllerMockEarnPointForLogin) Set(f func(ctx context.Context, user *model.User) (err error)) *IPointsControllerMock {
	if mmEarnPointForLogin.defaultExpectation != nil {
...
// Then helper
func (mmEarnPointForLogin *mIPointsControllerMockEarnPointForLogin) When(ctx context.Context, user *model.User) *IPointsControllerMockEarnPointForLoginExpectation {
	if mmEarnPointForLogin.mock.funcEarnPointForLogin != nil {
		mmEarnPointForLogin.mock.t.Fatalf("IPointsControllerMock.EarnPointForLogin mock is already set by Set")
	}
	...
	expectation := &IPointsControllerMockEarnPointForLoginExpectation{
		...
		params: &IPointsControllerMockEarnPointForLoginParams{ctx, user},
	}
...
// EarnPointForLogin implements IPointsController
func (mmEarnPointForLogin *IPointsControllerMock) EarnPointForLogin(ctx context.Context, user *model.User) (err error) {
	...
	if mmEarnPointForLogin.inspectFuncEarnPointForLogin != nil {
		mmEarnPointForLogin.inspectFuncEarnPointForLogin(ctx, user)
	}

	mm_params := &IPointsControllerMockEarnPointForLoginParams{ctx, user}
	...
	if mmEarnPointForLogin.EarnPointForLoginMock.defaultExpectation != nil {
		...
		mm_got := IPointsControllerMockEarnPointForLoginParams{ctx, user}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmEarnPointForLogin.funcEarnPointForLogin != nil {
		return mmEarnPointForLogin.funcEarnPointForLogin(ctx, user)
	}
	mmEarnPointForLogin.t.Fatalf("Unexpected call to IPointsControllerMock.EarnPointForLogin. %v %v", ctx, user)
	return
}
...
func (mmPurgePoint *mIPointsControllerMockPurgePoint) Expect(ctx context.Context, user *model.User, point int) *mIPointsControllerMockPurgePoint {
	...
	mmPurgePoint.defaultExpectation.params = &IPointsControllerMockPurgePointParams{ctx, user, point}
...
func (mmPurgePoint *mIPointsControllerMockPurgePoint) Inspect(f func(ctx context.Context, user *model.User, point int)) *mIPointsControllerMockPurgePoint {
...
func (mmPurgePoint *mIPointsControllerMockPurgePoint) Set(f func(ctx context.Context, user *model.User, point int) (err error)) *IPointsControllerMock {
	if mmPurgePoint.defaultExpectation != nil {
...
// Then helper
func (mmPurgePoint *mIPointsControllerMockPurgePoint) When(ctx context.Context, user *model.User, point int) *IPointsControllerMockPurgePointExpectation {
	if mmPurgePoint.mock.funcPurgePoint != nil {
		mmPurgePoint.mock.t.Fatalf("IPointsControllerMock.PurgePoint mock is already set by Set")
	}
	...
	expectation := &IPointsControllerMockPurgePointExpectation{
		...
		params: &IPointsControllerMockPurgePointParams{ctx, user, point},
	}
...
// PurgePoint implements IPointsController
func (mmPurgePoint *IPointsControllerMock) PurgePoint(ctx context.Context, user *model.User, point int) (err error) {
	...
	if mmPurgePoint.inspectFuncPurgePoint != nil {
		mmPurgePoint.inspectFuncPurgePoint(ctx, user, point)
	}

	mm_params := &IPointsControllerMockPurgePointParams{ctx, user, point}
	...
	if mmPurgePoint.PurgePointMock.defaultExpectation != nil {
		...
		mm_got := IPointsControllerMockPurgePointParams{ctx, user, point}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmPurgePoint.funcPurgePoint != nil {
		return mmPurgePoint.funcPurgePoint(ctx, user, point)
	}
	mmPurgePoint.t.Fatalf("Unexpected call to IPointsControllerMock.PurgePoint. %v %v %v", ctx, user, point)
	return
}
