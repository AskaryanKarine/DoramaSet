...
//go:generate minimock -i DoramaSet/internal/interfaces/controller.IPointsController -o ..\..\repository\mocks\i_points_controller_mock_test.go -n IPointsControllerMock
