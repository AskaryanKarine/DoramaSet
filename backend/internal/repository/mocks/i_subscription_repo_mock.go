...
//go:generate minimock -i DoramaSet/internal/interfaces/repository.ISubscriptionRepo -o ./i_subscription_repo_mock_test.go -n ISubscriptionRepoMock
...
// ISubscriptionRepoMock implements ISubscriptionRepo
type ISubscriptionRepoMock struct {
	t minimock.Tester

	funcGetList          func(ctx context.Context) (sa1 []model.Subscription, err error)
	...
	funcGetSubscription          func(ctx context.Context, id int) (sp1 *model.Subscription, err error)
	inspectFuncGetSubscription   func(ctx context.Context, id int)
	...
	funcGetSubscriptionByPrice          func(ctx context.Context, price int) (sp1 *model.Subscription, err error)
	inspectFuncGetSubscriptionByPrice   func(ctx context.Context, price int)
...
// NewISubscriptionRepoMock returns a mock for ISubscriptionRepo
func NewISubscriptionRepoMock(t minimock.Tester) *ISubscriptionRepoMock {
	...
	m.GetListMock.callArgs = []*ISubscriptionRepoMockGetListParams{}
...
type mISubscriptionRepoMockGetList struct {
	...
	callArgs []*ISubscriptionRepoMockGetListParams
	mutex    sync.RWMutex
}
...
type ISubscriptionRepoMockGetListExpectation struct {
	mock    *ISubscriptionRepoMock
	params  *ISubscriptionRepoMockGetListParams
	results *ISubscriptionRepoMockGetListResults
	Counter uint64
}

// ISubscriptionRepoMockGetListParams contains parameters of the ISubscriptionRepo.GetList
type ISubscriptionRepoMockGetListParams struct {
	ctx context.Context
}
...
func (mmGetList *mISubscriptionRepoMockGetList) Expect(ctx context.Context) *mISubscriptionRepoMockGetList {
	...
	mmGetList.defaultExpectation.params = &ISubscriptionRepoMockGetListParams{ctx}
...
func (mmGetList *mISubscriptionRepoMockGetList) Inspect(f func(ctx context.Context)) *mISubscriptionRepoMockGetList {
...
func (mmGetList *mISubscriptionRepoMockGetList) Set(f func(ctx context.Context) (sa1 []model.Subscription, err error)) *ISubscriptionRepoMock {
	if mmGetList.defaultExpectation != nil {
...
// When sets expectation for the ISubscriptionRepo.GetList which will trigger the result defined by the following
// Then helper
func (mmGetList *mISubscriptionRepoMockGetList) When(ctx context.Context) *ISubscriptionRepoMockGetListExpectation {
	if mmGetList.mock.funcGetList != nil {
		mmGetList.mock.t.Fatalf("ISubscriptionRepoMock.GetList mock is already set by Set")
	}

	expectation := &ISubscriptionRepoMockGetListExpectation{
		mock:   mmGetList.mock,
		params: &ISubscriptionRepoMockGetListParams{ctx},
	}
	mmGetList.expectations = append(mmGetList.expectations, expectation)
	return expectation
}

// Then sets up ISubscriptionRepo.GetList return parameters for the expectation previously defined by the When method
func (e *ISubscriptionRepoMockGetListExpectation) Then(sa1 []model.Subscription, err error) *ISubscriptionRepoMock {
	e.results = &ISubscriptionRepoMockGetListResults{sa1, err}
	return e.mock
}

// GetList implements ISubscriptionRepo
func (mmGetList *ISubscriptionRepoMock) GetList(ctx context.Context) (sa1 []model.Subscription, err error) {
	...
	mm_params := &ISubscriptionRepoMockGetListParams{ctx}
	...
	if mmGetList.GetListMock.defaultExpectation != nil {
		...
		mm_got := ISubscriptionRepoMockGetListParams{ctx}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetList.t.Errorf("ISubscriptionRepoMock.GetList got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
	...
	mmGetList.t.Fatalf("Unexpected call to ISubscriptionRepoMock.GetList. %v", ctx)
	return
}
...
// Calls returns a list of arguments used in each call to ISubscriptionRepoMock.GetList.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmGetList *mISubscriptionRepoMockGetList) Calls() []*ISubscriptionRepoMockGetListParams {
	mmGetList.mutex.RLock()

	argCopy := make([]*ISubscriptionRepoMockGetListParams, len(mmGetList.callArgs))
...
func (m *ISubscriptionRepoMock) MinimockGetListInspect() {
	for _, e := range m.GetListMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ISubscriptionRepoMock.GetList with params: %#v", *e.params)
		}
	}
	...
	if m.GetListMock.defaultExpectation != nil && mm_atomic.LoadUint64(&m.afterGetListCounter) < 1 {
		if m.GetListMock.defaultExpectation.params == nil {
			...
			m.t.Errorf("Expected call to ISubscriptionRepoMock.GetList with params: %#v", *m.GetListMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetList != nil && mm_atomic.LoadUint64(&m.afterGetListCounter) < 1 {
...
func (mmGetSubscription *mISubscriptionRepoMockGetSubscription) Expect(ctx context.Context, id int) *mISubscriptionRepoMockGetSubscription {
	...
	mmGetSubscription.defaultExpectation.params = &ISubscriptionRepoMockGetSubscriptionParams{ctx, id}
...
func (mmGetSubscription *mISubscriptionRepoMockGetSubscription) Inspect(f func(ctx context.Context, id int)) *mISubscriptionRepoMockGetSubscription {
...
func (mmGetSubscription *mISubscriptionRepoMockGetSubscription) Set(f func(ctx context.Context, id int) (sp1 *model.Subscription, err error)) *ISubscriptionRepoMock {
	if mmGetSubscription.defaultExpectation != nil {
...
// Then helper
func (mmGetSubscription *mISubscriptionRepoMockGetSubscription) When(ctx context.Context, id int) *ISubscriptionRepoMockGetSubscriptionExpectation {
	if mmGetSubscription.mock.funcGetSubscription != nil {
		mmGetSubscription.mock.t.Fatalf("ISubscriptionRepoMock.GetSubscription mock is already set by Set")
	}
	...
	expectation := &ISubscriptionRepoMockGetSubscriptionExpectation{
		...
		params: &ISubscriptionRepoMockGetSubscriptionParams{ctx, id},
	}
...
// GetSubscription implements ISubscriptionRepo
func (mmGetSubscription *ISubscriptionRepoMock) GetSubscription(ctx context.Context, id int) (sp1 *model.Subscription, err error) {
	...
	if mmGetSubscription.inspectFuncGetSubscription != nil {
		mmGetSubscription.inspectFuncGetSubscription(ctx, id)
	}

	mm_params := &ISubscriptionRepoMockGetSubscriptionParams{ctx, id}
	...
	if mmGetSubscription.GetSubscriptionMock.defaultExpectation != nil {
		...
		mm_got := ISubscriptionRepoMockGetSubscriptionParams{ctx, id}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetSubscription.funcGetSubscription != nil {
		return mmGetSubscription.funcGetSubscription(ctx, id)
	}
	mmGetSubscription.t.Fatalf("Unexpected call to ISubscriptionRepoMock.GetSubscription. %v %v", ctx, id)
	return
}
...
func (mmGetSubscriptionByPrice *mISubscriptionRepoMockGetSubscriptionByPrice) Expect(ctx context.Context, price int) *mISubscriptionRepoMockGetSubscriptionByPrice {
	...
	mmGetSubscriptionByPrice.defaultExpectation.params = &ISubscriptionRepoMockGetSubscriptionByPriceParams{ctx, price}
...
func (mmGetSubscriptionByPrice *mISubscriptionRepoMockGetSubscriptionByPrice) Inspect(f func(ctx context.Context, price int)) *mISubscriptionRepoMockGetSubscriptionByPrice {
...
func (mmGetSubscriptionByPrice *mISubscriptionRepoMockGetSubscriptionByPrice) Set(f func(ctx context.Context, price int) (sp1 *model.Subscription, err error)) *ISubscriptionRepoMock {
	if mmGetSubscriptionByPrice.defaultExpectation != nil {
...
// Then helper
func (mmGetSubscriptionByPrice *mISubscriptionRepoMockGetSubscriptionByPrice) When(ctx context.Context, price int) *ISubscriptionRepoMockGetSubscriptionByPriceExpectation {
	if mmGetSubscriptionByPrice.mock.funcGetSubscriptionByPrice != nil {
		mmGetSubscriptionByPrice.mock.t.Fatalf("ISubscriptionRepoMock.GetSubscriptionByPrice mock is already set by Set")
	}
	...
	expectation := &ISubscriptionRepoMockGetSubscriptionByPriceExpectation{
		...
		params: &ISubscriptionRepoMockGetSubscriptionByPriceParams{ctx, price},
	}
...
// GetSubscriptionByPrice implements ISubscriptionRepo
func (mmGetSubscriptionByPrice *ISubscriptionRepoMock) GetSubscriptionByPrice(ctx context.Context, price int) (sp1 *model.Subscription, err error) {
	...
	if mmGetSubscriptionByPrice.inspectFuncGetSubscriptionByPrice != nil {
		mmGetSubscriptionByPrice.inspectFuncGetSubscriptionByPrice(ctx, price)
	}

	mm_params := &ISubscriptionRepoMockGetSubscriptionByPriceParams{ctx, price}
	...
	if mmGetSubscriptionByPrice.GetSubscriptionByPriceMock.defaultExpectation != nil {
		...
		mm_got := ISubscriptionRepoMockGetSubscriptionByPriceParams{ctx, price}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetSubscriptionByPrice.funcGetSubscriptionByPrice != nil {
		return mmGetSubscriptionByPrice.funcGetSubscriptionByPrice(ctx, price)
	}
	mmGetSubscriptionByPrice.t.Fatalf("Unexpected call to ISubscriptionRepoMock.GetSubscriptionByPrice. %v %v", ctx, price)
	return
}
