...
//go:generate minimock -i DoramaSet/internal/interfaces/repository.ISubscriptionRepo -o ..\..\repository\mocks\i_subscription_repo_mock.go -n ISubscriptionRepoMock
