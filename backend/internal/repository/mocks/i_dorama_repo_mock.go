...
//go:generate minimock -i DoramaSet/internal/interfaces/repository.IDoramaRepo -o ./i_dorama_repo_mock_test.go -n IDoramaRepoMock
...
// IDoramaRepoMock implements IDoramaRepo
type IDoramaRepoMock struct {
	t minimock.Tester

	funcAddStaff          func(ctx context.Context, idD int, idS int) (err error)
	inspectFuncAddStaff   func(ctx context.Context, idD int, idS int)
	afterAddStaffCounter  uint64
	beforeAddStaffCounter uint64
	AddStaffMock          mIDoramaRepoMockAddStaff

	funcCreateDorama          func(ctx context.Context, dorama model.Dorama) (i1 int, err error)
	inspectFuncCreateDorama   func(ctx context.Context, dorama model.Dorama)
	afterCreateDoramaCounter  uint64
	beforeCreateDoramaCounter uint64
	CreateDoramaMock          mIDoramaRepoMockCreateDorama

	funcDeleteDorama          func(ctx context.Context, id int) (err error)
	inspectFuncDeleteDorama   func(ctx context.Context, id int)
	afterDeleteDoramaCounter  uint64
	beforeDeleteDoramaCounter uint64
	DeleteDoramaMock          mIDoramaRepoMockDeleteDorama

	funcGetDorama          func(ctx context.Context, id int) (dp1 *model.Dorama, err error)
	inspectFuncGetDorama   func(ctx context.Context, id int)
	afterGetDoramaCounter  uint64
	beforeGetDoramaCounter uint64
	GetDoramaMock          mIDoramaRepoMockGetDorama

	funcGetList          func(ctx context.Context) (da1 []model.Dorama, err error)
	...
	funcGetListByListId          func(ctx context.Context, idL int) (da1 []model.Dorama, err error)
	inspectFuncGetListByListId   func(ctx context.Context, idL int)
	afterGetListByListIdCounter  uint64
	beforeGetListByListIdCounter uint64
	GetListByListIdMock          mIDoramaRepoMockGetListByListId

	funcGetListName          func(ctx context.Context, name string) (da1 []model.Dorama, err error)
	inspectFuncGetListName   func(ctx context.Context, name string)
	afterGetListNameCounter  uint64
	beforeGetListNameCounter uint64
	GetListNameMock          mIDoramaRepoMockGetListName

	funcUpdateDorama          func(ctx context.Context, dorama model.Dorama) (err error)
	inspectFuncUpdateDorama   func(ctx context.Context, dorama model.Dorama)
	afterUpdateDoramaCounter  uint64
	beforeUpdateDoramaCounter uint64
	UpdateDoramaMock          mIDoramaRepoMockUpdateDorama
}

// NewIDoramaRepoMock returns a mock for IDoramaRepo
func NewIDoramaRepoMock(t minimock.Tester) *IDoramaRepoMock {
	...
	m.GetListMock.callArgs = []*IDoramaRepoMockGetListParams{}
...
func (mmAddStaff *mIDoramaRepoMockAddStaff) Expect(ctx context.Context, idD int, idS int) *mIDoramaRepoMockAddStaff {
	...
	mmAddStaff.defaultExpectation.params = &IDoramaRepoMockAddStaffParams{ctx, idD, idS}
...
func (mmAddStaff *mIDoramaRepoMockAddStaff) Inspect(f func(ctx context.Context, idD int, idS int)) *mIDoramaRepoMockAddStaff {
...
func (mmAddStaff *mIDoramaRepoMockAddStaff) Set(f func(ctx context.Context, idD int, idS int) (err error)) *IDoramaRepoMock {
	if mmAddStaff.defaultExpectation != nil {
...
// Then helper
func (mmAddStaff *mIDoramaRepoMockAddStaff) When(ctx context.Context, idD int, idS int) *IDoramaRepoMockAddStaffExpectation {
	if mmAddStaff.mock.funcAddStaff != nil {
		mmAddStaff.mock.t.Fatalf("IDoramaRepoMock.AddStaff mock is already set by Set")
	}
	...
	expectation := &IDoramaRepoMockAddStaffExpectation{
		...
		params: &IDoramaRepoMockAddStaffParams{ctx, idD, idS},
	}
...
// AddStaff implements IDoramaRepo
func (mmAddStaff *IDoramaRepoMock) AddStaff(ctx context.Context, idD int, idS int) (err error) {
	...
	if mmAddStaff.inspectFuncAddStaff != nil {
		mmAddStaff.inspectFuncAddStaff(ctx, idD, idS)
	}

	mm_params := &IDoramaRepoMockAddStaffParams{ctx, idD, idS}
	...
	if mmAddStaff.AddStaffMock.defaultExpectation != nil {
		...
		mm_got := IDoramaRepoMockAddStaffParams{ctx, idD, idS}
	...
	if mmAddStaff.funcAddStaff != nil {
		return mmAddStaff.funcAddStaff(ctx, idD, idS)
	}
	mmAddStaff.t.Fatalf("Unexpected call to IDoramaRepoMock.AddStaff. %v %v %v", ctx, idD, idS)
	return
}
...
func (mmCreateDorama *mIDoramaRepoMockCreateDorama) Expect(ctx context.Context, dorama model.Dorama) *mIDoramaRepoMockCreateDorama {
	...
	mmCreateDorama.defaultExpectation.params = &IDoramaRepoMockCreateDoramaParams{ctx, dorama}
...
func (mmCreateDorama *mIDoramaRepoMockCreateDorama) Inspect(f func(ctx context.Context, dorama model.Dorama)) *mIDoramaRepoMockCreateDorama {
...
func (mmCreateDorama *mIDoramaRepoMockCreateDorama) Set(f func(ctx context.Context, dorama model.Dorama) (i1 int, err error)) *IDoramaRepoMock {
	if mmCreateDorama.defaultExpectation != nil {
...
// Then helper
func (mmCreateDorama *mIDoramaRepoMockCreateDorama) When(ctx context.Context, dorama model.Dorama) *IDoramaRepoMockCreateDoramaExpectation {
	if mmCreateDorama.mock.funcCreateDorama != nil {
		mmCreateDorama.mock.t.Fatalf("IDoramaRepoMock.CreateDorama mock is already set by Set")
	}
	...
	expectation := &IDoramaRepoMockCreateDoramaExpectation{
		...
		params: &IDoramaRepoMockCreateDoramaParams{ctx, dorama},
	}
...
// CreateDorama implements IDoramaRepo
func (mmCreateDorama *IDoramaRepoMock) CreateDorama(ctx context.Context, dorama model.Dorama) (i1 int, err error) {
	...
	if mmCreateDorama.inspectFuncCreateDorama != nil {
		mmCreateDorama.inspectFuncCreateDorama(ctx, dorama)
	}

	mm_params := &IDoramaRepoMockCreateDoramaParams{ctx, dorama}
	...
	if mmCreateDorama.CreateDoramaMock.defaultExpectation != nil {
		...
		mm_got := IDoramaRepoMockCreateDoramaParams{ctx, dorama}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmCreateDorama.funcCreateDorama != nil {
		return mmCreateDorama.funcCreateDorama(ctx, dorama)
	}
	mmCreateDorama.t.Fatalf("Unexpected call to IDoramaRepoMock.CreateDorama. %v %v", ctx, dorama)
	return
}
...
func (mmDeleteDorama *mIDoramaRepoMockDeleteDorama) Expect(ctx context.Context, id int) *mIDoramaRepoMockDeleteDorama {
	...
	mmDeleteDorama.defaultExpectation.params = &IDoramaRepoMockDeleteDoramaParams{ctx, id}
...
func (mmDeleteDorama *mIDoramaRepoMockDeleteDorama) Inspect(f func(ctx context.Context, id int)) *mIDoramaRepoMockDeleteDorama {
...
func (mmDeleteDorama *mIDoramaRepoMockDeleteDorama) Set(f func(ctx context.Context, id int) (err error)) *IDoramaRepoMock {
	if mmDeleteDorama.defaultExpectation != nil {
...
// Then helper
func (mmDeleteDorama *mIDoramaRepoMockDeleteDorama) When(ctx context.Context, id int) *IDoramaRepoMockDeleteDoramaExpectation {
	if mmDeleteDorama.mock.funcDeleteDorama != nil {
		mmDeleteDorama.mock.t.Fatalf("IDoramaRepoMock.DeleteDorama mock is already set by Set")
	}
	...
	expectation := &IDoramaRepoMockDeleteDoramaExpectation{
		...
		params: &IDoramaRepoMockDeleteDoramaParams{ctx, id},
	}
...
// DeleteDorama implements IDoramaRepo
func (mmDeleteDorama *IDoramaRepoMock) DeleteDorama(ctx context.Context, id int) (err error) {
	...
	if mmDeleteDorama.inspectFuncDeleteDorama != nil {
		mmDeleteDorama.inspectFuncDeleteDorama(ctx, id)
	}

	mm_params := &IDoramaRepoMockDeleteDoramaParams{ctx, id}
	...
	if mmDeleteDorama.DeleteDoramaMock.defaultExpectation != nil {
		...
		mm_got := IDoramaRepoMockDeleteDoramaParams{ctx, id}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmDeleteDorama.funcDeleteDorama != nil {
		return mmDeleteDorama.funcDeleteDorama(ctx, id)
	}
	mmDeleteDorama.t.Fatalf("Unexpected call to IDoramaRepoMock.DeleteDorama. %v %v", ctx, id)
	return
}
...
func (mmGetDorama *mIDoramaRepoMockGetDorama) Expect(ctx context.Context, id int) *mIDoramaRepoMockGetDorama {
	...
	mmGetDorama.defaultExpectation.params = &IDoramaRepoMockGetDoramaParams{ctx, id}
...
func (mmGetDorama *mIDoramaRepoMockGetDorama) Inspect(f func(ctx context.Context, id int)) *mIDoramaRepoMockGetDorama {
...
func (mmGetDorama *mIDoramaRepoMockGetDorama) Set(f func(ctx context.Context, id int) (dp1 *model.Dorama, err error)) *IDoramaRepoMock {
	if mmGetDorama.defaultExpectation != nil {
...
// Then helper
func (mmGetDorama *mIDoramaRepoMockGetDorama) When(ctx context.Context, id int) *IDoramaRepoMockGetDoramaExpectation {
	if mmGetDorama.mock.funcGetDorama != nil {
		mmGetDorama.mock.t.Fatalf("IDoramaRepoMock.GetDorama mock is already set by Set")
	}
	...
	expectation := &IDoramaRepoMockGetDoramaExpectation{
		...
		params: &IDoramaRepoMockGetDoramaParams{ctx, id},
	}
...
// GetDorama implements IDoramaRepo
func (mmGetDorama *IDoramaRepoMock) GetDorama(ctx context.Context, id int) (dp1 *model.Dorama, err error) {
	...
	if mmGetDorama.inspectFuncGetDorama != nil {
		mmGetDorama.inspectFuncGetDorama(ctx, id)
	}

	mm_params := &IDoramaRepoMockGetDoramaParams{ctx, id}
	...
	if mmGetDorama.GetDoramaMock.defaultExpectation != nil {
		...
		mm_got := IDoramaRepoMockGetDoramaParams{ctx, id}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetDorama.funcGetDorama != nil {
		return mmGetDorama.funcGetDorama(ctx, id)
	}
	mmGetDorama.t.Fatalf("Unexpected call to IDoramaRepoMock.GetDorama. %v %v", ctx, id)
	return
}
...
type mIDoramaRepoMockGetList struct {
	...
	callArgs []*IDoramaRepoMockGetListParams
	mutex    sync.RWMutex
}
...
type IDoramaRepoMockGetListExpectation struct {
	mock    *IDoramaRepoMock
	params  *IDoramaRepoMockGetListParams
	results *IDoramaRepoMockGetListResults
	Counter uint64
}

// IDoramaRepoMockGetListParams contains parameters of the IDoramaRepo.GetList
type IDoramaRepoMockGetListParams struct {
	ctx context.Context
}
...
func (mmGetList *mIDoramaRepoMockGetList) Expect(ctx context.Context) *mIDoramaRepoMockGetList {
	...
	mmGetList.defaultExpectation.params = &IDoramaRepoMockGetListParams{ctx}
...
func (mmGetList *mIDoramaRepoMockGetList) Inspect(f func(ctx context.Context)) *mIDoramaRepoMockGetList {
...
func (mmGetList *mIDoramaRepoMockGetList) Set(f func(ctx context.Context) (da1 []model.Dorama, err error)) *IDoramaRepoMock {
	if mmGetList.defaultExpectation != nil {
...
// When sets expectation for the IDoramaRepo.GetList which will trigger the result defined by the following
// Then helper
func (mmGetList *mIDoramaRepoMockGetList) When(ctx context.Context) *IDoramaRepoMockGetListExpectation {
	if mmGetList.mock.funcGetList != nil {
		mmGetList.mock.t.Fatalf("IDoramaRepoMock.GetList mock is already set by Set")
	}

	expectation := &IDoramaRepoMockGetListExpectation{
		mock:   mmGetList.mock,
		params: &IDoramaRepoMockGetListParams{ctx},
	}
	mmGetList.expectations = append(mmGetList.expectations, expectation)
	return expectation
}

// Then sets up IDoramaRepo.GetList return parameters for the expectation previously defined by the When method
func (e *IDoramaRepoMockGetListExpectation) Then(da1 []model.Dorama, err error) *IDoramaRepoMock {
	e.results = &IDoramaRepoMockGetListResults{da1, err}
	return e.mock
}

// GetList implements IDoramaRepo
func (mmGetList *IDoramaRepoMock) GetList(ctx context.Context) (da1 []model.Dorama, err error) {
	...
	mm_params := &IDoramaRepoMockGetListParams{ctx}
	...
	if mmGetList.GetListMock.defaultExpectation != nil {
		...
		mm_got := IDoramaRepoMockGetListParams{ctx}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetList.t.Errorf("IDoramaRepoMock.GetList got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
	...
	mmGetList.t.Fatalf("Unexpected call to IDoramaRepoMock.GetList. %v", ctx)
	return
}
...
// Calls returns a list of arguments used in each call to IDoramaRepoMock.GetList.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmGetList *mIDoramaRepoMockGetList) Calls() []*IDoramaRepoMockGetListParams {
	mmGetList.mutex.RLock()

	argCopy := make([]*IDoramaRepoMockGetListParams, len(mmGetList.callArgs))
...
func (m *IDoramaRepoMock) MinimockGetListInspect() {
	for _, e := range m.GetListMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to IDoramaRepoMock.GetList with params: %#v", *e.params)
		}
	}
	...
	if m.GetListMock.defaultExpectation != nil && mm_atomic.LoadUint64(&m.afterGetListCounter) < 1 {
		if m.GetListMock.defaultExpectation.params == nil {
			...
			m.t.Errorf("Expected call to IDoramaRepoMock.GetList with params: %#v", *m.GetListMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetList != nil && mm_atomic.LoadUint64(&m.afterGetListCounter) < 1 {
...
func (mmGetListByListId *mIDoramaRepoMockGetListByListId) Expect(ctx context.Context, idL int) *mIDoramaRepoMockGetListByListId {
	...
	mmGetListByListId.defaultExpectation.params = &IDoramaRepoMockGetListByListIdParams{ctx, idL}
...
func (mmGetListByListId *mIDoramaRepoMockGetListByListId) Inspect(f func(ctx context.Context, idL int)) *mIDoramaRepoMockGetListByListId {
...
func (mmGetListByListId *mIDoramaRepoMockGetListByListId) Set(f func(ctx context.Context, idL int) (da1 []model.Dorama, err error)) *IDoramaRepoMock {
	if mmGetListByListId.defaultExpectation != nil {
...
// Then helper
func (mmGetListByListId *mIDoramaRepoMockGetListByListId) When(ctx context.Context, idL int) *IDoramaRepoMockGetListByListIdExpectation {
	if mmGetListByListId.mock.funcGetListByListId != nil {
		mmGetListByListId.mock.t.Fatalf("IDoramaRepoMock.GetListByListId mock is already set by Set")
	}
	...
	expectation := &IDoramaRepoMockGetListByListIdExpectation{
		...
		params: &IDoramaRepoMockGetListByListIdParams{ctx, idL},
	}
...
// GetListByListId implements IDoramaRepo
func (mmGetListByListId *IDoramaRepoMock) GetListByListId(ctx context.Context, idL int) (da1 []model.Dorama, err error) {
	...
	if mmGetListByListId.inspectFuncGetListByListId != nil {
		mmGetListByListId.inspectFuncGetListByListId(ctx, idL)
	}

	mm_params := &IDoramaRepoMockGetListByListIdParams{ctx, idL}
	...
	if mmGetListByListId.GetListByListIdMock.defaultExpectation != nil {
		...
		mm_got := IDoramaRepoMockGetListByListIdParams{ctx, idL}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetListByListId.funcGetListByListId != nil {
		return mmGetListByListId.funcGetListByListId(ctx, idL)
	}
	mmGetListByListId.t.Fatalf("Unexpected call to IDoramaRepoMock.GetListByListId. %v %v", ctx, idL)
	return
}
...
func (mmGetListName *mIDoramaRepoMockGetListName) Expect(ctx context.Context, name string) *mIDoramaRepoMockGetListName {
	...
	mmGetListName.defaultExpectation.params = &IDoramaRepoMockGetListNameParams{ctx, name}
...
func (mmGetListName *mIDoramaRepoMockGetListName) Inspect(f func(ctx context.Context, name string)) *mIDoramaRepoMockGetListName {
...
func (mmGetListName *mIDoramaRepoMockGetListName) Set(f func(ctx context.Context, name string) (da1 []model.Dorama, err error)) *IDoramaRepoMock {
	if mmGetListName.defaultExpectation != nil {
...
// Then helper
func (mmGetListName *mIDoramaRepoMockGetListName) When(ctx context.Context, name string) *IDoramaRepoMockGetListNameExpectation {
	if mmGetListName.mock.funcGetListName != nil {
		mmGetListName.mock.t.Fatalf("IDoramaRepoMock.GetListName mock is already set by Set")
	}
	...
	expectation := &IDoramaRepoMockGetListNameExpectation{
		...
		params: &IDoramaRepoMockGetListNameParams{ctx, name},
	}
...
// GetListName implements IDoramaRepo
func (mmGetListName *IDoramaRepoMock) GetListName(ctx context.Context, name string) (da1 []model.Dorama, err error) {
	...
	if mmGetListName.inspectFuncGetListName != nil {
		mmGetListName.inspectFuncGetListName(ctx, name)
	}

	mm_params := &IDoramaRepoMockGetListNameParams{ctx, name}
	...
	if mmGetListName.GetListNameMock.defaultExpectation != nil {
		...
		mm_got := IDoramaRepoMockGetListNameParams{ctx, name}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetListName.funcGetListName != nil {
		return mmGetListName.funcGetListName(ctx, name)
	}
	mmGetListName.t.Fatalf("Unexpected call to IDoramaRepoMock.GetListName. %v %v", ctx, name)
	return
}
...
func (mmUpdateDorama *mIDoramaRepoMockUpdateDorama) Expect(ctx context.Context, dorama model.Dorama) *mIDoramaRepoMockUpdateDorama {
	...
	mmUpdateDorama.defaultExpectation.params = &IDoramaRepoMockUpdateDoramaParams{ctx, dorama}
...
func (mmUpdateDorama *mIDoramaRepoMockUpdateDorama) Inspect(f func(ctx context.Context, dorama model.Dorama)) *mIDoramaRepoMockUpdateDorama {
...
func (mmUpdateDorama *mIDoramaRepoMockUpdateDorama) Set(f func(ctx context.Context, dorama model.Dorama) (err error)) *IDoramaRepoMock {
	if mmUpdateDorama.defaultExpectation != nil {
...
// Then helper
func (mmUpdateDorama *mIDoramaRepoMockUpdateDorama) When(ctx context.Context, dorama model.Dorama) *IDoramaRepoMockUpdateDoramaExpectation {
	if mmUpdateDorama.mock.funcUpdateDorama != nil {
		mmUpdateDorama.mock.t.Fatalf("IDoramaRepoMock.UpdateDorama mock is already set by Set")
	}
	...
	expectation := &IDoramaRepoMockUpdateDoramaExpectation{
		...
		params: &IDoramaRepoMockUpdateDoramaParams{ctx, dorama},
	}
...
// UpdateDorama implements IDoramaRepo
func (mmUpdateDorama *IDoramaRepoMock) UpdateDorama(ctx context.Context, dorama model.Dorama) (err error) {
	...
	if mmUpdateDorama.inspectFuncUpdateDorama != nil {
		mmUpdateDorama.inspectFuncUpdateDorama(ctx, dorama)
	}

	mm_params := &IDoramaRepoMockUpdateDoramaParams{ctx, dorama}
	...
	if mmUpdateDorama.UpdateDoramaMock.defaultExpectation != nil {
		...
		mm_got := IDoramaRepoMockUpdateDoramaParams{ctx, dorama}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmUpdateDorama.funcUpdateDorama != nil {
		return mmUpdateDorama.funcUpdateDorama(ctx, dorama)
	}
	mmUpdateDorama.t.Fatalf("Unexpected call to IDoramaRepoMock.UpdateDorama. %v %v", ctx, dorama)
	return
}
