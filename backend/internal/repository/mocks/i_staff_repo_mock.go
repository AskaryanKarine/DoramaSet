...
//go:generate minimock -i DoramaSet/internal/interfaces/repository.IStaffRepo -o ./i_staff_repo_mock_test.go -n IStaffRepoMock
...
// IStaffRepoMock implements IStaffRepo
type IStaffRepoMock struct {
	t minimock.Tester

	funcCreateStaff          func(ctx context.Context, record model.Staff) (i1 int, err error)
	inspectFuncCreateStaff   func(ctx context.Context, record model.Staff)
	afterCreateStaffCounter  uint64
	beforeCreateStaffCounter uint64
	CreateStaffMock          mIStaffRepoMockCreateStaff

	funcDeleteStaff          func(ctx context.Context, id int) (err error)
	inspectFuncDeleteStaff   func(ctx context.Context, id int)
	afterDeleteStaffCounter  uint64
	beforeDeleteStaffCounter uint64
	DeleteStaffMock          mIStaffRepoMockDeleteStaff

	funcGetList          func(ctx context.Context) (sa1 []model.Staff, err error)
	...
	funcGetListDorama          func(ctx context.Context, idDorama int) (sa1 []model.Staff, err error)
	...
	funcGetListName          func(ctx context.Context, name string) (sa1 []model.Staff, err error)
	...
	funcGetStaffById          func(ctx context.Context, id int) (sp1 *model.Staff, err error)
	inspectFuncGetStaffById   func(ctx context.Context, id int)
	afterGetStaffByIdCounter  uint64
	beforeGetStaffByIdCounter uint64
	GetStaffByIdMock          mIStaffRepoMockGetStaffById

	funcUpdateStaff          func(ctx context.Context, record model.Staff) (err error)
	inspectFuncUpdateStaff   func(ctx context.Context, record model.Staff)
	afterUpdateStaffCounter  uint64
	beforeUpdateStaffCounter uint64
	UpdateStaffMock          mIStaffRepoMockUpdateStaff
}

// NewIStaffRepoMock returns a mock for IStaffRepo
func NewIStaffRepoMock(t minimock.Tester) *IStaffRepoMock {
	...
	m.GetListMock.callArgs = []*IStaffRepoMockGetListParams{}
...
func (mmCreateStaff *mIStaffRepoMockCreateStaff) Expect(ctx context.Context, record model.Staff) *mIStaffRepoMockCreateStaff {
	...
	mmCreateStaff.defaultExpectation.params = &IStaffRepoMockCreateStaffParams{ctx, record}
...
func (mmCreateStaff *mIStaffRepoMockCreateStaff) Inspect(f func(ctx context.Context, record model.Staff)) *mIStaffRepoMockCreateStaff {
...
func (mmCreateStaff *mIStaffRepoMockCreateStaff) Set(f func(ctx context.Context, record model.Staff) (i1 int, err error)) *IStaffRepoMock {
	if mmCreateStaff.defaultExpectation != nil {
...
// Then helper
func (mmCreateStaff *mIStaffRepoMockCreateStaff) When(ctx context.Context, record model.Staff) *IStaffRepoMockCreateStaffExpectation {
	if mmCreateStaff.mock.funcCreateStaff != nil {
		mmCreateStaff.mock.t.Fatalf("IStaffRepoMock.CreateStaff mock is already set by Set")
	}
	...
	expectation := &IStaffRepoMockCreateStaffExpectation{
		...
		params: &IStaffRepoMockCreateStaffParams{ctx, record},
	}
...
// CreateStaff implements IStaffRepo
func (mmCreateStaff *IStaffRepoMock) CreateStaff(ctx context.Context, record model.Staff) (i1 int, err error) {
	...
	if mmCreateStaff.inspectFuncCreateStaff != nil {
		mmCreateStaff.inspectFuncCreateStaff(ctx, record)
	}

	mm_params := &IStaffRepoMockCreateStaffParams{ctx, record}
	...
	if mmCreateStaff.CreateStaffMock.defaultExpectation != nil {
		...
		mm_got := IStaffRepoMockCreateStaffParams{ctx, record}
	...
	if mmCreateStaff.funcCreateStaff != nil {
		return mmCreateStaff.funcCreateStaff(ctx, record)
	}
	mmCreateStaff.t.Fatalf("Unexpected call to IStaffRepoMock.CreateStaff. %v %v", ctx, record)
	return
}
...
func (mmDeleteStaff *mIStaffRepoMockDeleteStaff) Expect(ctx context.Context, id int) *mIStaffRepoMockDeleteStaff {
	...
	mmDeleteStaff.defaultExpectation.params = &IStaffRepoMockDeleteStaffParams{ctx, id}
...
func (mmDeleteStaff *mIStaffRepoMockDeleteStaff) Inspect(f func(ctx context.Context, id int)) *mIStaffRepoMockDeleteStaff {
...
func (mmDeleteStaff *mIStaffRepoMockDeleteStaff) Set(f func(ctx context.Context, id int) (err error)) *IStaffRepoMock {
	if mmDeleteStaff.defaultExpectation != nil {
...
// Then helper
func (mmDeleteStaff *mIStaffRepoMockDeleteStaff) When(ctx context.Context, id int) *IStaffRepoMockDeleteStaffExpectation {
	if mmDeleteStaff.mock.funcDeleteStaff != nil {
		mmDeleteStaff.mock.t.Fatalf("IStaffRepoMock.DeleteStaff mock is already set by Set")
	}
	...
	expectation := &IStaffRepoMockDeleteStaffExpectation{
		...
		params: &IStaffRepoMockDeleteStaffParams{ctx, id},
	}
...
// DeleteStaff implements IStaffRepo
func (mmDeleteStaff *IStaffRepoMock) DeleteStaff(ctx context.Context, id int) (err error) {
	...
	if mmDeleteStaff.inspectFuncDeleteStaff != nil {
		mmDeleteStaff.inspectFuncDeleteStaff(ctx, id)
	}

	mm_params := &IStaffRepoMockDeleteStaffParams{ctx, id}
	...
	if mmDeleteStaff.DeleteStaffMock.defaultExpectation != nil {
		...
		mm_got := IStaffRepoMockDeleteStaffParams{ctx, id}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmDeleteStaff.funcDeleteStaff != nil {
		return mmDeleteStaff.funcDeleteStaff(ctx, id)
	}
	mmDeleteStaff.t.Fatalf("Unexpected call to IStaffRepoMock.DeleteStaff. %v %v", ctx, id)
	return
}
...
type mIStaffRepoMockGetList struct {
	...
	callArgs []*IStaffRepoMockGetListParams
	mutex    sync.RWMutex
}
...
type IStaffRepoMockGetListExpectation struct {
	mock    *IStaffRepoMock
	params  *IStaffRepoMockGetListParams
	results *IStaffRepoMockGetListResults
	Counter uint64
}

// IStaffRepoMockGetListParams contains parameters of the IStaffRepo.GetList
type IStaffRepoMockGetListParams struct {
	ctx context.Context
}
...
func (mmGetList *mIStaffRepoMockGetList) Expect(ctx context.Context) *mIStaffRepoMockGetList {
	...
	mmGetList.defaultExpectation.params = &IStaffRepoMockGetListParams{ctx}
...
func (mmGetList *mIStaffRepoMockGetList) Inspect(f func(ctx context.Context)) *mIStaffRepoMockGetList {
...
func (mmGetList *mIStaffRepoMockGetList) Set(f func(ctx context.Context) (sa1 []model.Staff, err error)) *IStaffRepoMock {
	if mmGetList.defaultExpectation != nil {
...
// When sets expectation for the IStaffRepo.GetList which will trigger the result defined by the following
// Then helper
func (mmGetList *mIStaffRepoMockGetList) When(ctx context.Context) *IStaffRepoMockGetListExpectation {
	if mmGetList.mock.funcGetList != nil {
		mmGetList.mock.t.Fatalf("IStaffRepoMock.GetList mock is already set by Set")
	}

	expectation := &IStaffRepoMockGetListExpectation{
		mock:   mmGetList.mock,
		params: &IStaffRepoMockGetListParams{ctx},
	}
	mmGetList.expectations = append(mmGetList.expectations, expectation)
	return expectation
}

// Then sets up IStaffRepo.GetList return parameters for the expectation previously defined by the When method
func (e *IStaffRepoMockGetListExpectation) Then(sa1 []model.Staff, err error) *IStaffRepoMock {
	e.results = &IStaffRepoMockGetListResults{sa1, err}
	return e.mock
}

// GetList implements IStaffRepo
func (mmGetList *IStaffRepoMock) GetList(ctx context.Context) (sa1 []model.Staff, err error) {
	...
	mm_params := &IStaffRepoMockGetListParams{ctx}
	...
	if mmGetList.GetListMock.defaultExpectation != nil {
		...
		mm_got := IStaffRepoMockGetListParams{ctx}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetList.t.Errorf("IStaffRepoMock.GetList got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
	...
	mmGetList.t.Fatalf("Unexpected call to IStaffRepoMock.GetList. %v", ctx)
	return
}
...
// Calls returns a list of arguments used in each call to IStaffRepoMock.GetList.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmGetList *mIStaffRepoMockGetList) Calls() []*IStaffRepoMockGetListParams {
	mmGetList.mutex.RLock()

	argCopy := make([]*IStaffRepoMockGetListParams, len(mmGetList.callArgs))
...
func (m *IStaffRepoMock) MinimockGetListInspect() {
	for _, e := range m.GetListMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to IStaffRepoMock.GetList with params: %#v", *e.params)
		}
	}
	...
	if m.GetListMock.defaultExpectation != nil && mm_atomic.LoadUint64(&m.afterGetListCounter) < 1 {
		if m.GetListMock.defaultExpectation.params == nil {
			...
			m.t.Errorf("Expected call to IStaffRepoMock.GetList with params: %#v", *m.GetListMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetList != nil && mm_atomic.LoadUint64(&m.afterGetListCounter) < 1 {
...
func (mmGetListDorama *mIStaffRepoMockGetListDorama) Expect(ctx context.Context, idDorama int) *mIStaffRepoMockGetListDorama {
	...
	mmGetListDorama.defaultExpectation.params = &IStaffRepoMockGetListDoramaParams{ctx, idDorama}
...
func (mmGetListDorama *mIStaffRepoMockGetListDorama) Inspect(f func(ctx context.Context, idDorama int)) *mIStaffRepoMockGetListDorama {
...
func (mmGetListDorama *mIStaffRepoMockGetListDorama) Set(f func(ctx context.Context, idDorama int) (sa1 []model.Staff, err error)) *IStaffRepoMock {
	if mmGetListDorama.defaultExpectation != nil {
...
// Then helper
func (mmGetListDorama *mIStaffRepoMockGetListDorama) When(ctx context.Context, idDorama int) *IStaffRepoMockGetListDoramaExpectation {
	if mmGetListDorama.mock.funcGetListDorama != nil {
		mmGetListDorama.mock.t.Fatalf("IStaffRepoMock.GetListDorama mock is already set by Set")
	}
	...
	expectation := &IStaffRepoMockGetListDoramaExpectation{
		...
		params: &IStaffRepoMockGetListDoramaParams{ctx, idDorama},
	}
...
// GetListDorama implements IStaffRepo
func (mmGetListDorama *IStaffRepoMock) GetListDorama(ctx context.Context, idDorama int) (sa1 []model.Staff, err error) {
	...
	mm_params := &IStaffRepoMockGetListDoramaParams{ctx, idDorama}
	...
	if mmGetListDorama.GetListDoramaMock.defaultExpectation != nil {
		...
		mm_got := IStaffRepoMockGetListDoramaParams{ctx, idDorama}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGetListDorama.t.Fatalf("Unexpected call to IStaffRepoMock.GetListDorama. %v %v", ctx, idDorama)
	return
}
...
func (mmGetListName *mIStaffRepoMockGetListName) Expect(ctx context.Context, name string) *mIStaffRepoMockGetListName {
	...
	mmGetListName.defaultExpectation.params = &IStaffRepoMockGetListNameParams{ctx, name}
...
func (mmGetListName *mIStaffRepoMockGetListName) Inspect(f func(ctx context.Context, name string)) *mIStaffRepoMockGetListName {
...
func (mmGetListName *mIStaffRepoMockGetListName) Set(f func(ctx context.Context, name string) (sa1 []model.Staff, err error)) *IStaffRepoMock {
	if mmGetListName.defaultExpectation != nil {
...
// Then helper
func (mmGetListName *mIStaffRepoMockGetListName) When(ctx context.Context, name string) *IStaffRepoMockGetListNameExpectation {
	if mmGetListName.mock.funcGetListName != nil {
		mmGetListName.mock.t.Fatalf("IStaffRepoMock.GetListName mock is already set by Set")
	}
	...
	expectation := &IStaffRepoMockGetListNameExpectation{
		...
		params: &IStaffRepoMockGetListNameParams{ctx, name},
	}
...
// GetListName implements IStaffRepo
func (mmGetListName *IStaffRepoMock) GetListName(ctx context.Context, name string) (sa1 []model.Staff, err error) {
	...
	mm_params := &IStaffRepoMockGetListNameParams{ctx, name}
	...
	if mmGetListName.GetListNameMock.defaultExpectation != nil {
		...
		mm_got := IStaffRepoMockGetListNameParams{ctx, name}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGetListName.t.Fatalf("Unexpected call to IStaffRepoMock.GetListName. %v %v", ctx, name)
	return
}
...
func (mmGetStaffById *mIStaffRepoMockGetStaffById) Expect(ctx context.Context, id int) *mIStaffRepoMockGetStaffById {
	...
	mmGetStaffById.defaultExpectation.params = &IStaffRepoMockGetStaffByIdParams{ctx, id}
...
func (mmGetStaffById *mIStaffRepoMockGetStaffById) Inspect(f func(ctx context.Context, id int)) *mIStaffRepoMockGetStaffById {
...
func (mmGetStaffById *mIStaffRepoMockGetStaffById) Set(f func(ctx context.Context, id int) (sp1 *model.Staff, err error)) *IStaffRepoMock {
	if mmGetStaffById.defaultExpectation != nil {
...
// Then helper
func (mmGetStaffById *mIStaffRepoMockGetStaffById) When(ctx context.Context, id int) *IStaffRepoMockGetStaffByIdExpectation {
	if mmGetStaffById.mock.funcGetStaffById != nil {
		mmGetStaffById.mock.t.Fatalf("IStaffRepoMock.GetStaffById mock is already set by Set")
	}
	...
	expectation := &IStaffRepoMockGetStaffByIdExpectation{
		...
		params: &IStaffRepoMockGetStaffByIdParams{ctx, id},
	}
...
// GetStaffById implements IStaffRepo
func (mmGetStaffById *IStaffRepoMock) GetStaffById(ctx context.Context, id int) (sp1 *model.Staff, err error) {
	...
	if mmGetStaffById.inspectFuncGetStaffById != nil {
		mmGetStaffById.inspectFuncGetStaffById(ctx, id)
	}

	mm_params := &IStaffRepoMockGetStaffByIdParams{ctx, id}
	...
	if mmGetStaffById.GetStaffByIdMock.defaultExpectation != nil {
		...
		mm_got := IStaffRepoMockGetStaffByIdParams{ctx, id}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetStaffById.funcGetStaffById != nil {
		return mmGetStaffById.funcGetStaffById(ctx, id)
	}
	mmGetStaffById.t.Fatalf("Unexpected call to IStaffRepoMock.GetStaffById. %v %v", ctx, id)
	return
}
...
func (mmUpdateStaff *mIStaffRepoMockUpdateStaff) Expect(ctx context.Context, record model.Staff) *mIStaffRepoMockUpdateStaff {
	...
	mmUpdateStaff.defaultExpectation.params = &IStaffRepoMockUpdateStaffParams{ctx, record}
...
func (mmUpdateStaff *mIStaffRepoMockUpdateStaff) Inspect(f func(ctx context.Context, record model.Staff)) *mIStaffRepoMockUpdateStaff {
...
func (mmUpdateStaff *mIStaffRepoMockUpdateStaff) Set(f func(ctx context.Context, record model.Staff) (err error)) *IStaffRepoMock {
	if mmUpdateStaff.defaultExpectation != nil {
...
// Then helper
func (mmUpdateStaff *mIStaffRepoMockUpdateStaff) When(ctx context.Context, record model.Staff) *IStaffRepoMockUpdateStaffExpectation {
	if mmUpdateStaff.mock.funcUpdateStaff != nil {
		mmUpdateStaff.mock.t.Fatalf("IStaffRepoMock.UpdateStaff mock is already set by Set")
	}
	...
	expectation := &IStaffRepoMockUpdateStaffExpectation{
		...
		params: &IStaffRepoMockUpdateStaffParams{ctx, record},
	}
...
// UpdateStaff implements IStaffRepo
func (mmUpdateStaff *IStaffRepoMock) UpdateStaff(ctx context.Context, record model.Staff) (err error) {
	...
	if mmUpdateStaff.inspectFuncUpdateStaff != nil {
		mmUpdateStaff.inspectFuncUpdateStaff(ctx, record)
	}

	mm_params := &IStaffRepoMockUpdateStaffParams{ctx, record}
	...
	if mmUpdateStaff.UpdateStaffMock.defaultExpectation != nil {
		...
		mm_got := IStaffRepoMockUpdateStaffParams{ctx, record}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmUpdateStaff.funcUpdateStaff != nil {
		return mmUpdateStaff.funcUpdateStaff(ctx, record)
	}
	mmUpdateStaff.t.Fatalf("Unexpected call to IStaffRepoMock.UpdateStaff. %v %v", ctx, record)
	return
}
