...
//go:generate minimock -i DoramaSet/internal/interfaces/repository.IPictureRepo -o ..\..\repository\mocks\i_picture_repo_mock.go -n IPictureRepoMock
...
type IPictureRepoMock struct {
	...
	funcDeletePicture          func(id int) (err error)
	inspectFuncDeletePicture   func(id int)
...
func (mmDeletePicture *mIPictureRepoMockDeletePicture) Expect(id int) *mIPictureRepoMockDeletePicture {
	...
	mmDeletePicture.defaultExpectation.params = &IPictureRepoMockDeletePictureParams{id}
...
func (mmDeletePicture *mIPictureRepoMockDeletePicture) Inspect(f func(id int)) *mIPictureRepoMockDeletePicture {
...
func (mmDeletePicture *mIPictureRepoMockDeletePicture) Set(f func(id int) (err error)) *IPictureRepoMock {
	if mmDeletePicture.defaultExpectation != nil {
...
// Then helper
func (mmDeletePicture *mIPictureRepoMockDeletePicture) When(id int) *IPictureRepoMockDeletePictureExpectation {
	if mmDeletePicture.mock.funcDeletePicture != nil {
		mmDeletePicture.mock.t.Fatalf("IPictureRepoMock.DeletePicture mock is already set by Set")
	}
	...
	expectation := &IPictureRepoMockDeletePictureExpectation{
		...
		params: &IPictureRepoMockDeletePictureParams{id},
	}
...
// DeletePicture implements repository.IPictureRepo
func (mmDeletePicture *IPictureRepoMock) DeletePicture(id int) (err error) {
	...
	if mmDeletePicture.inspectFuncDeletePicture != nil {
		mmDeletePicture.inspectFuncDeletePicture(id)
	}

	mm_params := &IPictureRepoMockDeletePictureParams{id}
	...
	if mmDeletePicture.DeletePictureMock.defaultExpectation != nil {
		...
		mm_got := IPictureRepoMockDeletePictureParams{id}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmDeletePicture.funcDeletePicture != nil {
		return mmDeletePicture.funcDeletePicture(id)
	}
	mmDeletePicture.t.Fatalf("Unexpected call to IPictureRepoMock.DeletePicture. %v", id)
	return
}
