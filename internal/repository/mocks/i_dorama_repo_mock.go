...
//go:generate minimock -i DoramaSet/internal/interfaces.IDoramaRepo -o ..\repository\mocks\i_dorama_repo_mock_test.go -n IDoramaRepoMock
...
// IDoramaRepoMock implements interfaces.IDoramaRepo
type IDoramaRepoMock struct {
	t minimock.Tester

	funcCreateDorama          func(dorama model.Dorama) (err error)
...
// NewIDoramaRepoMock returns a mock for interfaces.IDoramaRepo
...
func (mmCreateDorama *mIDoramaRepoMockCreateDorama) Return(err error) *IDoramaRepoMock {
	if mmCreateDorama.mock.funcCreateDorama != nil {
		mmCreateDorama.mock.t.Fatalf("IDoramaRepoMock.CreateDorama mock is already set by Set")
	}
	...
	mmCreateDorama.defaultExpectation.results = &IDoramaRepoMockCreateDoramaResults{err}
	return mmCreateDorama.mock
}

// Set uses given function f to mock the IDoramaRepo.CreateDorama method
func (mmCreateDorama *mIDoramaRepoMockCreateDorama) Set(f func(dorama model.Dorama) (err error)) *IDoramaRepoMock {
	if mmCreateDorama.defaultExpectation != nil {
...
func (e *IDoramaRepoMockCreateDoramaExpectation) Then(err error) *IDoramaRepoMock {
	e.results = &IDoramaRepoMockCreateDoramaResults{err}
	return e.mock
}

// CreateDorama implements interfaces.IDoramaRepo
func (mmCreateDorama *IDoramaRepoMock) CreateDorama(dorama model.Dorama) (err error) {
...
// GetDorama implements interfaces.IDoramaRepo
...
// GetList implements interfaces.IDoramaRepo
...
// GetListName implements interfaces.IDoramaRepo
...
// UpdateDorama implements interfaces.IDoramaRepo
