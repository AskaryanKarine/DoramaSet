...
//go:generate minimock -i DoramaSet/internal/interfaces.IPointsController -o ..\repository\mocks\i_points_controller_mock_test.go -n IPointsControllerMock
...
// IPointsControllerMock implements interfaces.IPointsController
type IPointsControllerMock struct {
	t minimock.Tester

	funcEarnPoint          func(username string, point int) (err error)
	inspectFuncEarnPoint   func(username string, point int)
	afterEarnPointCounter  uint64
	beforeEarnPointCounter uint64
	EarnPointMock          mIPointsControllerMockEarnPoint

	funcEarnPointForLogin          func(username string) (err error)
	inspectFuncEarnPointForLogin   func(username string)
	...
	funcPurgePoint          func(username string, point int) (err error)
	inspectFuncPurgePoint   func(username string, point int)
	afterPurgePointCounter  uint64
	beforePurgePointCounter uint64
	PurgePointMock          mIPointsControllerMockPurgePoint
}

// NewIPointsControllerMock returns a mock for interfaces.IPointsController
...
func (mmEarnPoint *mIPointsControllerMockEarnPoint) Expect(username string, point int) *mIPointsControllerMockEarnPoint {
	...
	mmEarnPoint.defaultExpectation.params = &IPointsControllerMockEarnPointParams{username, point}
...
func (mmEarnPoint *mIPointsControllerMockEarnPoint) Inspect(f func(username string, point int)) *mIPointsControllerMockEarnPoint {
...
func (mmEarnPoint *mIPointsControllerMockEarnPoint) Set(f func(username string, point int) (err error)) *IPointsControllerMock {
	if mmEarnPoint.defaultExpectation != nil {
...
// Then helper
func (mmEarnPoint *mIPointsControllerMockEarnPoint) When(username string, point int) *IPointsControllerMockEarnPointExpectation {
	if mmEarnPoint.mock.funcEarnPoint != nil {
		mmEarnPoint.mock.t.Fatalf("IPointsControllerMock.EarnPoint mock is already set by Set")
	}
	...
	expectation := &IPointsControllerMockEarnPointExpectation{
		...
		params: &IPointsControllerMockEarnPointParams{username, point},
	}
...
// EarnPoint implements interfaces.IPointsController
func (mmEarnPoint *IPointsControllerMock) EarnPoint(username string, point int) (err error) {
	...
	if mmEarnPoint.inspectFuncEarnPoint != nil {
		mmEarnPoint.inspectFuncEarnPoint(username, point)
	}

	mm_params := &IPointsControllerMockEarnPointParams{username, point}
	...
	if mmEarnPoint.EarnPointMock.defaultExpectation != nil {
		...
		mm_got := IPointsControllerMockEarnPointParams{username, point}
	...
	if mmEarnPoint.funcEarnPoint != nil {
		return mmEarnPoint.funcEarnPoint(username, point)
	}
	mmEarnPoint.t.Fatalf("Unexpected call to IPointsControllerMock.EarnPoint. %v %v", username, point)
	return
}
...
func (mmEarnPointForLogin *mIPointsControllerMockEarnPointForLogin) Expect(username string) *mIPointsControllerMockEarnPointForLogin {
	...
	mmEarnPointForLogin.defaultExpectation.params = &IPointsControllerMockEarnPointForLoginParams{username}
...
func (mmEarnPointForLogin *mIPointsControllerMockEarnPointForLogin) Inspect(f func(username string)) *mIPointsControllerMockEarnPointForLogin {
...
func (mmEarnPointForLogin *mIPointsControllerMockEarnPointForLogin) Set(f func(username string) (err error)) *IPointsControllerMock {
	if mmEarnPointForLogin.defaultExpectation != nil {
...
// Then helper
func (mmEarnPointForLogin *mIPointsControllerMockEarnPointForLogin) When(username string) *IPointsControllerMockEarnPointForLoginExpectation {
	if mmEarnPointForLogin.mock.funcEarnPointForLogin != nil {
		mmEarnPointForLogin.mock.t.Fatalf("IPointsControllerMock.EarnPointForLogin mock is already set by Set")
	}
	...
	expectation := &IPointsControllerMockEarnPointForLoginExpectation{
		...
		params: &IPointsControllerMockEarnPointForLoginParams{username},
	}
...
// EarnPointForLogin implements interfaces.IPointsController
func (mmEarnPointForLogin *IPointsControllerMock) EarnPointForLogin(username string) (err error) {
	...
	if mmEarnPointForLogin.inspectFuncEarnPointForLogin != nil {
		mmEarnPointForLogin.inspectFuncEarnPointForLogin(username)
	}

	mm_params := &IPointsControllerMockEarnPointForLoginParams{username}
	...
	if mmEarnPointForLogin.EarnPointForLoginMock.defaultExpectation != nil {
		...
		mm_got := IPointsControllerMockEarnPointForLoginParams{username}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmEarnPointForLogin.funcEarnPointForLogin != nil {
		return mmEarnPointForLogin.funcEarnPointForLogin(username)
	}
	mmEarnPointForLogin.t.Fatalf("Unexpected call to IPointsControllerMock.EarnPointForLogin. %v", username)
	return
}
...
func (mmPurgePoint *mIPointsControllerMockPurgePoint) Expect(username string, point int) *mIPointsControllerMockPurgePoint {
	...
	mmPurgePoint.defaultExpectation.params = &IPointsControllerMockPurgePointParams{username, point}
...
func (mmPurgePoint *mIPointsControllerMockPurgePoint) Inspect(f func(username string, point int)) *mIPointsControllerMockPurgePoint {
...
func (mmPurgePoint *mIPointsControllerMockPurgePoint) Set(f func(username string, point int) (err error)) *IPointsControllerMock {
	if mmPurgePoint.defaultExpectation != nil {
...
// Then helper
func (mmPurgePoint *mIPointsControllerMockPurgePoint) When(username string, point int) *IPointsControllerMockPurgePointExpectation {
	if mmPurgePoint.mock.funcPurgePoint != nil {
		mmPurgePoint.mock.t.Fatalf("IPointsControllerMock.PurgePoint mock is already set by Set")
	}
	...
	expectation := &IPointsControllerMockPurgePointExpectation{
		...
		params: &IPointsControllerMockPurgePointParams{username, point},
	}
...
// PurgePoint implements interfaces.IPointsController
func (mmPurgePoint *IPointsControllerMock) PurgePoint(username string, point int) (err error) {
	...
	if mmPurgePoint.inspectFuncPurgePoint != nil {
		mmPurgePoint.inspectFuncPurgePoint(username, point)
	}

	mm_params := &IPointsControllerMockPurgePointParams{username, point}
	...
	if mmPurgePoint.PurgePointMock.defaultExpectation != nil {
		...
		mm_got := IPointsControllerMockPurgePointParams{username, point}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmPurgePoint.funcPurgePoint != nil {
		return mmPurgePoint.funcPurgePoint(username, point)
	}
	mmPurgePoint.t.Fatalf("Unexpected call to IPointsControllerMock.PurgePoint. %v %v", username, point)
	return
}
