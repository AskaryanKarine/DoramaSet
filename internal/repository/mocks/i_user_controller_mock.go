...
//go:generate minimock -i DoramaSet/internal/interfaces.IUserController -o ..\repository\mocks\i_user_controller_mock_test.go -n IUserControllerMock
...
// IUserControllerMock implements interfaces.IUserController
type IUserControllerMock struct {
	...
	funcLogin          func(record model.User) (s1 string, err error)
	inspectFuncLogin   func(record model.User)
...
// NewIUserControllerMock returns a mock for interfaces.IUserController
...
// AuthByToken implements interfaces.IUserController
...
func (mmLogin *mIUserControllerMockLogin) Expect(record model.User) *mIUserControllerMockLogin {
	...
	mmLogin.defaultExpectation.params = &IUserControllerMockLoginParams{record}
...
func (mmLogin *mIUserControllerMockLogin) Inspect(f func(record model.User)) *mIUserControllerMockLogin {
...
func (mmLogin *mIUserControllerMockLogin) Set(f func(record model.User) (s1 string, err error)) *IUserControllerMock {
	if mmLogin.defaultExpectation != nil {
...
// Then helper
func (mmLogin *mIUserControllerMockLogin) When(record model.User) *IUserControllerMockLoginExpectation {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("IUserControllerMock.Login mock is already set by Set")
	}
	...
	expectation := &IUserControllerMockLoginExpectation{
		mock:   mmLogin.mock,
		params: &IUserControllerMockLoginParams{record},
	}
...
// Login implements interfaces.IUserController
func (mmLogin *IUserControllerMock) Login(record model.User) (s1 string, err error) {
	...
	if mmLogin.inspectFuncLogin != nil {
		mmLogin.inspectFuncLogin(record)
	}

	mm_params := &IUserControllerMockLoginParams{record}
	...
	if mmLogin.LoginMock.defaultExpectation != nil {
		...
		mm_got := IUserControllerMockLoginParams{record}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmLogin.funcLogin != nil {
		return mmLogin.funcLogin(record)
	}
	mmLogin.t.Fatalf("Unexpected call to IUserControllerMock.Login. %v", record)
	return
}
...
// Registration implements interfaces.IUserController
...
// UpdateActive implements interfaces.IUserController
